        ...
        <>
            <WebLayout>
                <div className="w-full max-w-[1200px] sm:px-0 px-4 mx-auto">
                    <h1 className="sm:text-5xl text-3xl font-bold text-center gradient-text SF_Pro sm:py-12 py-8 border-b border-[#E2E2E2]">Cancellaction Policy</h1>
